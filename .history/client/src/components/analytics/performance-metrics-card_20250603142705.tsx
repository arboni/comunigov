      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Média de Tempo de Tarefas</p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Média de Reuniões executadas</p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Comunicações/Mês</p>
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Tarefas/Mês</p>
