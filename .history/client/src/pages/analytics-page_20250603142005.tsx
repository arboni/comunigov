                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="bg-neutral-100 p-4 rounded-md">
                          ...
                          <p className="text-2xl font-semibold">{analyticsData?.taskInsights?.avgCompletionDays?.toFixed(1) || 0} dias</p>
                        </div>
                      </div>
                    </div>
                  </CardContent>
                      ...
                      <div className="space-y-2">
                        {isLoadingEntityAnalytics ? (
                          ...
                          entityAnalytics?.byCommunication?.map(
                            (entity: { name: string; communicationCount: number }, index: number) => (
                              <div key={index} className="flex items-center justify-between bg-neutral-50 p-2 rounded-md">
                                <span className="text-sm font-medium">{entity.name}</span>
