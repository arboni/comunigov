CREATE DATABASE  IF NOT EXISTS `comunigov` /*!40100 DEFAULT CHARACTER SET latin1 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `comunigov`;
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: comunigov
-- ------------------------------------------------------
...
-- Dump completed on 2025-06-05 16:32:35
