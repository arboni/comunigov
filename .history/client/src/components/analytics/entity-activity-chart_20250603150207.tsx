...
export default function EntityActivityChart({ data, isLoading }: EntityActivityChartProps) {
    ...
    return (
      <Card>
        <CardHeader className="pb-2">
          <CardTitle className="text-lg">Atividade da Entidade</CardTitle>
        </CardHeader>
  ...
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-lg">Taxa de Atividades da Entidade</CardTitle>
      </CardHeader>
      <CardContent>
        {top10Entities.length > 0 ? (
          ...
          <div className="h-80 flex items-center justify-center">
            <p className="text-muted-foreground">Sem informações disponíveis</p>
          </div>
        )}
      </CardContent>
    </Card>
