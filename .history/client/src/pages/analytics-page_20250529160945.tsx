      ...
      <div className="py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              <h1 className="text-2xl font-semibold text-neutral-800">Advanced Analytics</h1>
              <p className="mt-1 text-sm text-neutral-500">
                Comprehensive data visualization and analysis for your institutional communications
              </p>
            </div>
