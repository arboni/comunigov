          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
              ...
              <p className="mt-1 text-sm text-neutral-500">
                Análise de dados é fundamental para entender o desempenho e a eficácia das comunicações institucionais.<br>

                Aqui você pode visualizar métricas de desempenho, tendências de atividade e insights sobre tarefas e comunicações.
                Use os filtros para ajustar o período de análise e exportar os dados conforme necessário.
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Key metrics and trends for tasks</CardDescription>
                  </CardHeader>
                  <CardContent>
