        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          <Tabs defaultValue="activity" className="w-full">
            ...
            <TabsContent value="hearings" className="space-y-6">
             ...
             <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">Audiência Públicas</CardTitle>
                    <CardDescription>Métrica de Execução de Audiências Públicas</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="bg-neutral-100 p-4 rounded-md">
                          <p className="text-sm text-neutral-500">Audiências Públicas</p>
                          <p className="text-2xl font-semibold">{analyticsData?.taskInsights?.totalActive || 0}</p>
                        </div>
                        <div className="bg-neutral-100 p-4 rounded-md">
                          <p className="text-sm text-neutral-500">Executadas no último mês</p>
                          <p className="text-2xl font-semibold">{analyticsData?.taskInsights?.completedLastMonth || 0}</p>
                        </div>
                        <div className="bg-neutral-100 p-4 rounded-md">
                          <p className="text-sm text-neutral-500">Atrasadas</p>
